...
const main = async err => {
  ...
  function positionRandom(foto) {
    ...
    if (!executed) {
      executed = true;
      const ancho = Math.floor(Math.random() * window.innerWidth);
      const alto = Math.floor(Math.random() * window.innerHeight);
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "b38cae5fe36443295cce"; }
/******/ }();
/******/ 
/******/ }
);