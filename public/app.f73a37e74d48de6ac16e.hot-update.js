...
const main = async err => {
  ...
  function positionRandom(foto) {
    ...
    if (!executed) {
      executed = true;
      const ancho = window.innerWidth / 2 - foto.innerWidth;
      const alto = window.innerHeight / 2 - foto - innerHeight;
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "afc6359eb6c42ba2b9ba"; }
/******/ }();
/******/ 
/******/ }
);