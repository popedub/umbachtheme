...
const main = async err => {
  ...
  function getAltura() {
    ...
    let footer = document.getElementById('footer'); //le damos la altura de la galería de forma dinamica

    let galeria = document.getElementById('galeria-home'); //caculamos la altura y le restamos el header, el page-header y el footer le damos la altura al main
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "9373371e1082c7360dca"; }
/******/ }();
/******/ 
/******/ }
);