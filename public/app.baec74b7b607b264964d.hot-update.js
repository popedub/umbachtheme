...
const main = async err => {
  ...
  if (document.body.classList.contains('category-ceramics')) {
    ...
    }); //tooltips de las featured images que llevan al single post

    var tooltips = document.querySelectorAll('.tooltops span');
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "04282343801da42c6362"; }
/******/ }();
/******/ 
/******/ }
);