...
const main = async err => {
  ...
  function positionRandom(foto) {
    ...
    if (!executed) {
      executed = true;
      const ancho = window.innerWidth / 2 - foto.naturalWidth;
      const alto = window.innerHeight / 2 - foto.naturalHeifht;
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "9c97c2b7102eb06c0dc6"; }
/******/ }();
/******/ 
/******/ }
);