...
const main = async err => {
  ...
  if (document.body.classList.contains('page-template-template-verkauf')) {
    ...
    if (items) {
      ...
      if (items.length == 2) {
        container.classList.add('lg:w-1/2');
        foto.classList.add('lg:w-1/2', 'lg:border-l-2', 'border-black');
      }

      if (items.length == 3) {
        console.log('3');
        container.classList.add('lg:w-2/3');
        foto.classList.add('lg:w-1/3', 'lg:border-r-2', 'border-black');
      }
    }
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "c0d93c3f5807e08b32ec"; }
/******/ }();
/******/ 
/******/ }
);