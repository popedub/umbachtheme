...
const main = async err => {
  ...
  function getAltura(elemento) {
    ...
    let alt = elemento.offsetHeight;
    let pageHeader = document.getElementsByClassName('page-header');
    console.log(pageHeader); //caculamos la altura y le restamos el header y el page-header le damos la altura al main

    alt = window.innerHeight - alt;
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "1c5000b600516f6def75"; }
/******/ }();
/******/ 
/******/ }
);