...
const main = async err => {
  ...
  function getAltura(elemento) {
    ...
    let alt = elemento.offsetTop;
    let pageHeader = document.getElementsByClassName('page-header');
    console.log(pageHeader[0].offsetTop); //caculamos la altura y le restamos el header y el page-header le damos la altura al main

    alt = window.innerHeight - alt - pageHeader[0].offsetTop;
    let div = document.getElementById('main');
    div.style.height = `${alt}` + 'px';
  }

  let div = document.getElementsByClassName('banner');
  getAltura(div[0]);
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "28bd741bd8f80bcc17da"; }
/******/ }();
/******/ 
/******/ }
);