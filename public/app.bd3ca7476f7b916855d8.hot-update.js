...
const main = async err => {
  ...
  function moverMenu() {
    //let menuClone = [...items];
    const menuDesplazado = document.getElementById('fake-ceramica div ul.nav-ceramics');
    ...
    console.log(menuDesplazado); // for (let i = 0; i < menuDesplazado.length; i++) {
    //   console.log(menuDesplazado[i])
    //   if (menuDesplazado[i].classList.contains('current-menu-item')) {
    //     menuDesplazado[i].classList.add('hidden')
    //   } else {
    //     menuDesplazado[i].classList.add('flex')
    //   }
    // }
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "e566dfa35660c16561fa"; }
/******/ }();
/******/ 
/******/ }
);