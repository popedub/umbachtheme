...
const main = async err => {
  ...
  function getAltura() {
    ...
    alt = window.innerHeight - alt - footer.offsetHeight + pageHeader[0].offsetHeight;
    let div = document.getElementById('main');
    div.style.height = `${alt}` + 'px'; //div.style.paddingTop = pageHeader[0].offsetHeight + 'px';
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "7c157f26f5a9ea16037f"; }
/******/ }();
/******/ 
/******/ }
);