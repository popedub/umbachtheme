...
const main = async err => {
  ...
  if (document.body.classList.contains('page-template-template-classes')) {
    ...
    if (items) {
      ...
      if (items.length == 2) {
        container.classList.add('lg:1/2', 'lg:border-r-2', 'border-black');
        foto.classList.add('lg:1/2');
      }

      if (items.length == 3) {
        container.classList.add('lg:2/3', 'lg:border-r-2', 'border-black');
        foto.classList.add('lg:1/2');
      }
    }
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "12f34e067daf6a94e690"; }
/******/ }();
/******/ 
/******/ }
);