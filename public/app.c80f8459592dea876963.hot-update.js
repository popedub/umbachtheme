...
const main = async err => {
  ...
  if (document.body.classList.contains('category')) {
    ...
    for (let i = 0; i < galerias.length; i++) {
      ...
      variablesToInit[i] = 'myGaleria' + i;
      galeriaToInit.push(`gal${i}`);
    }

    console.log(variablesToInit);

    for (let i = 0; i < galeriaToInit.length; i++) {
      var g = variablesToInit[i] = new swiper_bundle__WEBPACK_IMPORTED_MODULE_3__["default"](galeriaToInit[i], {
        slidesPerView: 1,
        centeredSlides: true,
        speed: 400,
        spaceBetween: 100,
      ...
      }); // var myGaleria = new Swiper('.galeria', {
      //   // configure Swiper to use modules
      //   // Optional parameters
      //   slidesPerView: 1,
      //   centeredSlides: true,
      ...
      //   },
      // })
    } //galerias en las entradas que no son ceremics
    // var myGaleria = new Swiper('.galeria', {
    //   // configure Swiper to use modules
    //   // Optional parameters
    //   slidesPerView: 1,
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "622af52cb463138cce3a"; }
/******/ }();
/******/ 
/******/ }
);