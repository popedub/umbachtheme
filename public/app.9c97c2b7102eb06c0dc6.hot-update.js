...
const main = async err => {
  ...
  function positionRandom(foto) {
    ...
    if (!executed) {
      executed = true;
      const ancho = Math.floor(Math.ramdom() * window.innerWidth);
      const alto = Math.floor(Math.ramdom() * window.innerHeight);
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "37fe74eef4eec6d40fec"; }
/******/ }();
/******/ 
/******/ }
);