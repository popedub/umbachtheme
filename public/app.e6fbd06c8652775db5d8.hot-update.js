...
const main = async err => {
  ...
  if (document.body.classList.contains('category')) {
    ...
    console.log(galeriaToInit);

    for (let i = 0; i < galeriaToInit.length; i++) {// var myGaleria = new Swiper('.galeria', {
      //   // configure Swiper to use modules
      //   // Optional parameters
      //   slidesPerView: 1,
      //   centeredSlides: true,
    ...
    console.log(galeriaToInit); //galerias en las entradas que no son ceremics
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "d5bef8024ce0837048f7"; }
/******/ }();
/******/ 
/******/ }
);